...
func EndpointCandidateFromShareBundle(bundle *ClientEndpointShareBundleV1) (EndpointCandidate, error) {
	...
	candidate := EndpointCandidate{
		...
		SuggestedLabel: bundle.GetSuggestedLabel(), Platform: bundle.GetPlatform(), ConnectMode: mapWireConnectMode(bundle.GetConnectMode()), SelectionPolicy: &policy, ApplyClientPolicy: true,
	}
