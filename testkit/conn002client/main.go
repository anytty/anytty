...
func main() {
	...
	clientLabel := flag.String("client-label", "conn002-harness", "pool access-list label")
	identityDir := flag.String("identity-dir", "", "pool DeviceIdentity directory")
	accessDir := flag.String("access-dir", "", "pool AccessStore directory")
