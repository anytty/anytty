...
type ApplicationSessionPort interface {
	...
	ApplicationTerminalResize(context.Context, []byte, Size, TerminalResizePolicy, bool, uint64) (TerminalResizeResult, error)
	...
	ApplicationRemoteCloudStatus(context.Context) (RemoteCloudStatus, error)
	ApplicationRemoteCloudEnable(context.Context) (RemoteCloudStatus, error)
	ApplicationRemoteCloudDisable(context.Context) (RemoteCloudStatus, error)
