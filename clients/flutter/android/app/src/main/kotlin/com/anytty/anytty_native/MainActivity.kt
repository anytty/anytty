...
class MainActivity : FlutterActivity() {
    ...
    private var browserProxyOperationGeneration: Long = 0
    ...
    private fun openBrowserProxy(call: MethodCall, result: MethodChannel.Result) {
        ...
        val config = ProxyConfig.Builder()
            ...
            .removeImplicitRules()
            .build()
        val operationGeneration = ++browserProxyOperationGeneration
        ProxyController.getInstance().setProxyOverride(config, browserCallbackExecutor()) {
            if (operationGeneration == browserProxyOperationGeneration) {
