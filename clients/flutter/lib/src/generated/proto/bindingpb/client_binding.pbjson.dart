...
const ResourceStreamFrameType$json = {
  ...
  '2': [
    ...
    {'1': 'RESOURCE_STREAM_FRAME_TYPE_BROWSER_DATA', '2': 10},
    {'1': 'RESOURCE_STREAM_FRAME_TYPE_BROWSER_CLOSED', '2': 11},
  ],
};
...
final $typed_data.Uint8List resourceStreamFrameTypeDescriptor = $convert.base64Decode(
    ...
    'UEVfUFRZX0NMT1NFRBAJEisKJ1JFU09VUkNFX1NUUkVBTV9GUkFNRV9UWVBFX0JST1dTRVJfRE'
    'FUQRAKEi0KKVJFU09VUkNFX1NUUkVBTV9GUkFNRV9UWVBFX0JST1dTRVJfQ0xPU0VEEAs=');
