...
export function FilePreviewSheet({ path, preview, loading, error, streamPreview, onClose }: FilePreviewSheetProps) {
  ...
  const sheet = (
    ...
    >
      <header className="anytty-app-header flex min-h-11 shrink-0 items-center gap-2 border-b px-2.5 pb-1.5 pt-[calc(env(safe-area-inset-top)+0.375rem)] md:h-11 md:py-0">
