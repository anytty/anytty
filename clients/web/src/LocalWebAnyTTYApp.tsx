...
import { WebSocketBindingBackend, type BindingBridgeEndpoint } from './WebSocketBindingBackend'
...
export function parseLocalWebBootstrap(value: unknown): LocalWebBootstrap | null {
  ...
  if (bridge.path !== '/api/bridge') return null
  ...
  return {
    bridge: { path: '/api/bridge', token: bridge.token },
    machine: {
      id: 'local',
