...
func TestDirectListenerSeedsProjectWildcardToPrivateLAN(t *testing.T) {
	previous := direct.PrivateLANAddresses
	direct.PrivateLANAddresses = func() ([]string, error) { return []string{"192.168.1.20", "10.0.0.8"}, nil }
	t.Cleanup(func() { direct.PrivateLANAddresses = previous })
...
func TestDirectPairingRouteUsesRecordedPoolListenerByDefault(t *testing.T) {
	previous := direct.PrivateLANAddresses
	direct.PrivateLANAddresses = func() ([]string, error) { return []string{"192.168.1.28"}, nil }
	t.Cleanup(func() { direct.PrivateLANAddresses = previous })
