...
// IdentityVerified 表示 adapter 已按 route 类型完成身份边界；managed/SSH 使用 channel-bound DeviceHello 或 Proto challenge proof，local-unix 使用 owner-only socket 边界与规范化本地投影。
