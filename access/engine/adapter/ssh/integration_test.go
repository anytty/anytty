...
func (sshCoreAccessService) Identity(context.Context, []byte) (accesscontract.ClientAccessIdentity, error) {
	return accesscontract.ClientAccessIdentity{}, nil
}

func (sshCoreAccessService) CreateTicket(context.Context, accesscontract.ClientAccessTicketRequest) (accesscontract.ClientAccessTicket, error) {
	return accesscontract.ClientAccessTicket{}, nil
}

func (sshCoreAccessService) List(context.Context) ([]accesscontract.ClientAccessRecord, error) {
	return nil, nil
}
...
func (sshCoreAccessService) Revoke(context.Context, string) (accesscontract.ClientAccessRecord, error) {
