...
func dialOrStartV3TUIClient(path, logFile string, logger *slog.Logger) (*protocoladapter.ApplicationClient, error) {
	return connectLocalApplicationClientWithName(context.Background(), path, logFile, "", tuiEndpointClientName, logger)
}
