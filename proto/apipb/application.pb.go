...
const file_apipb_application_proto_rawDesc = "" +
	...
	"\bresource\x18\x02 \x01(\v2\x1d.anytty.api.v1.ResourceHandleR\bresourceJ\x04\b\x01\x10\x02\"\xd3#\n" +
	...
	"\x14remote_cloud_disable\x18x \x01(\v2(.anytty.api.v1.RemoteCloudDisableCommandH\x00R\x12remoteCloudDisableB\t\n" +
	"\acommand\"\x13\n" +
	"\x11AcknowledgeResult\"\xe7\x16\n" +
	...
	"\x13remote_cloud_status\x18r \x01(\v2&.anytty.api.v1.RemoteCloudStatusResultH\x00R\x11remoteCloudStatusB\b\n" +
	"\x06result\"V\n" +
...
var file_apipb_application_proto_goTypes = []any{
	...
	(*RemoteCloudStatusCommand)(nil),        // 60: anytty.api.v1.RemoteCloudStatusCommand
	(*RemoteCloudEnableCommand)(nil),        // 61: anytty.api.v1.RemoteCloudEnableCommand
	(*RemoteCloudDisableCommand)(nil),       // 62: anytty.api.v1.RemoteCloudDisableCommand
	(*EndpointSessionStamp)(nil),            // 63: anytty.api.v1.EndpointSessionStamp
	(*ApiError)(nil),                        // 64: anytty.api.v1.ApiError
	(*TerminalDefaultsResult)(nil),          // 65: anytty.api.v1.TerminalDefaultsResult
	(*TerminalCreateResult)(nil),            // 66: anytty.api.v1.TerminalCreateResult
	(*TerminalListResult)(nil),              // 67: anytty.api.v1.TerminalListResult
	(*TerminalGetResult)(nil),               // 68: anytty.api.v1.TerminalGetResult
	(*TerminalAttachResult)(nil),            // 69: anytty.api.v1.TerminalAttachResult
	(*TerminalResizeResult)(nil),            // 70: anytty.api.v1.TerminalResizeResult
	(*PathListDirectoriesResult)(nil),       // 71: anytty.api.v1.PathListDirectoriesResult
	(*HistoryWindowResult)(nil),             // 72: anytty.api.v1.HistoryWindowResult
	(*HistoryCopyResult)(nil),               // 73: anytty.api.v1.HistoryCopyResult
	(*HistoryBacklogStatusResult)(nil),      // 74: anytty.api.v1.HistoryBacklogStatusResult
	(*NativeScreenResult)(nil),              // 75: anytty.api.v1.NativeScreenResult
	(*HistorySearchResult)(nil),             // 76: anytty.api.v1.HistorySearchResult
	(*EventSubscriptionResult)(nil),         // 77: anytty.api.v1.EventSubscriptionResult
	(*FileListResult)(nil),                  // 78: anytty.api.v1.FileListResult
	(*FileStatResult)(nil),                  // 79: anytty.api.v1.FileStatResult
	(*FilePreviewResult)(nil),               // 80: anytty.api.v1.FilePreviewResult
	(*FileOperationResult)(nil),             // 81: anytty.api.v1.FileOperationResult
	(*FileBatchResult)(nil),                 // 82: anytty.api.v1.FileBatchResult
	(*FileTransferOpenResult)(nil),          // 83: anytty.api.v1.FileTransferOpenResult
	(*FileTransferCancelResult)(nil),        // 84: anytty.api.v1.FileTransferCancelResult
	(*StorageGetResult)(nil),                // 85: anytty.api.v1.StorageGetResult
	(*StoragePutResult)(nil),                // 86: anytty.api.v1.StoragePutResult
	(*StorageDeleteResult)(nil),             // 87: anytty.api.v1.StorageDeleteResult
	(*StorageListResult)(nil),               // 88: anytty.api.v1.StorageListResult
	(*ClientAccessIdentityResult)(nil),      // 89: anytty.api.v1.ClientAccessIdentityResult
	(*ClientAccessListResult)(nil),          // 90: anytty.api.v1.ClientAccessListResult
	(*ClientAccessTicketCreateResult)(nil),  // 91: anytty.api.v1.ClientAccessTicketCreateResult
	(*ClientAccessRevokeResult)(nil),        // 92: anytty.api.v1.ClientAccessRevokeResult
	(*RemoteStatusResult)(nil),              // 93: anytty.api.v1.RemoteStatusResult
	(*RemotePairStartResult)(nil),           // 94: anytty.api.v1.RemotePairStartResult
	(*RemoteLocalStatusResult)(nil),         // 95: anytty.api.v1.RemoteLocalStatusResult
	(*RemoteCloudEdgesResult)(nil),          // 96: anytty.api.v1.RemoteCloudEdgesResult
	(*RemoteCloudStatusResult)(nil),         // 97: anytty.api.v1.RemoteCloudStatusResult
	(*ApiVersion)(nil),                      // 98: anytty.api.v1.ApiVersion
	(*TerminalLifecycleEvent)(nil),          // 99: anytty.api.v1.TerminalLifecycleEvent
	(*StorageChangedEvent)(nil),             // 100: anytty.api.v1.StorageChangedEvent
	(*FileTransferCompletedEvent)(nil),      // 101: anytty.api.v1.FileTransferCompletedEvent
}
var file_apipb_application_proto_depIdxs = []int32{
	...
	60,  // 54: anytty.api.v1.CommandEnvelope.remote_cloud_status:type_name -> anytty.api.v1.RemoteCloudStatusCommand
	61,  // 55: anytty.api.v1.CommandEnvelope.remote_cloud_enable:type_name -> anytty.api.v1.RemoteCloudEnableCommand
	62,  // 56: anytty.api.v1.CommandEnvelope.remote_cloud_disable:type_name -> anytty.api.v1.RemoteCloudDisableCommand
	63,  // 57: anytty.api.v1.ResultEnvelope.origin_session:type_name -> anytty.api.v1.EndpointSessionStamp
	3,   // 58: anytty.api.v1.ResultEnvelope.acknowledge:type_name -> anytty.api.v1.AcknowledgeResult
	64,  // 59: anytty.api.v1.ResultEnvelope.error:type_name -> anytty.api.v1.ApiError
	65,  // 60: anytty.api.v1.ResultEnvelope.terminal_defaults:type_name -> anytty.api.v1.TerminalDefaultsResult
	66,  // 61: anytty.api.v1.ResultEnvelope.terminal_create:type_name -> anytty.api.v1.TerminalCreateResult
	67,  // 62: anytty.api.v1.ResultEnvelope.terminal_list:type_name -> anytty.api.v1.TerminalListResult
	68,  // 63: anytty.api.v1.ResultEnvelope.terminal_get:type_name -> anytty.api.v1.TerminalGetResult
	69,  // 64: anytty.api.v1.ResultEnvelope.terminal_attach:type_name -> anytty.api.v1.TerminalAttachResult
	70,  // 65: anytty.api.v1.ResultEnvelope.terminal_resize:type_name -> anytty.api.v1.TerminalResizeResult
	71,  // 66: anytty.api.v1.ResultEnvelope.path_list_directories:type_name -> anytty.api.v1.PathListDirectoriesResult
	72,  // 67: anytty.api.v1.ResultEnvelope.history_window:type_name -> anytty.api.v1.HistoryWindowResult
	73,  // 68: anytty.api.v1.ResultEnvelope.history_copy:type_name -> anytty.api.v1.HistoryCopyResult
	74,  // 69: anytty.api.v1.ResultEnvelope.history_backlog_status:type_name -> anytty.api.v1.HistoryBacklogStatusResult
	75,  // 70: anytty.api.v1.ResultEnvelope.live_screen:type_name -> anytty.api.v1.NativeScreenResult
	76,  // 71: anytty.api.v1.ResultEnvelope.history_search:type_name -> anytty.api.v1.HistorySearchResult
	77,  // 72: anytty.api.v1.ResultEnvelope.event_subscription:type_name -> anytty.api.v1.EventSubscriptionResult
	78,  // 73: anytty.api.v1.ResultEnvelope.file_list:type_name -> anytty.api.v1.FileListResult
	79,  // 74: anytty.api.v1.ResultEnvelope.file_stat:type_name -> anytty.api.v1.FileStatResult
	80,  // 75: anytty.api.v1.ResultEnvelope.file_preview:type_name -> anytty.api.v1.FilePreviewResult
	81,  // 76: anytty.api.v1.ResultEnvelope.file_operation:type_name -> anytty.api.v1.FileOperationResult
	82,  // 77: anytty.api.v1.ResultEnvelope.file_batch:type_name -> anytty.api.v1.FileBatchResult
	83,  // 78: anytty.api.v1.ResultEnvelope.file_transfer_open:type_name -> anytty.api.v1.FileTransferOpenResult
	84,  // 79: anytty.api.v1.ResultEnvelope.file_transfer_cancel:type_name -> anytty.api.v1.FileTransferCancelResult
	85,  // 80: anytty.api.v1.ResultEnvelope.storage_get:type_name -> anytty.api.v1.StorageGetResult
	86,  // 81: anytty.api.v1.ResultEnvelope.storage_put:type_name -> anytty.api.v1.StoragePutResult
	87,  // 82: anytty.api.v1.ResultEnvelope.storage_delete:type_name -> anytty.api.v1.StorageDeleteResult
	88,  // 83: anytty.api.v1.ResultEnvelope.storage_list:type_name -> anytty.api.v1.StorageListResult
	89,  // 84: anytty.api.v1.ResultEnvelope.client_access_identity:type_name -> anytty.api.v1.ClientAccessIdentityResult
	90,  // 85: anytty.api.v1.ResultEnvelope.client_access_list:type_name -> anytty.api.v1.ClientAccessListResult
	91,  // 86: anytty.api.v1.ResultEnvelope.client_access_ticket_create:type_name -> anytty.api.v1.ClientAccessTicketCreateResult
	92,  // 87: anytty.api.v1.ResultEnvelope.client_access_revoke:type_name -> anytty.api.v1.ClientAccessRevokeResult
	93,  // 88: anytty.api.v1.ResultEnvelope.remote_status:type_name -> anytty.api.v1.RemoteStatusResult
	94,  // 89: anytty.api.v1.ResultEnvelope.remote_pair_start:type_name -> anytty.api.v1.RemotePairStartResult
	95,  // 90: anytty.api.v1.ResultEnvelope.remote_local_status:type_name -> anytty.api.v1.RemoteLocalStatusResult
	96,  // 91: anytty.api.v1.ResultEnvelope.remote_cloud_edges:type_name -> anytty.api.v1.RemoteCloudEdgesResult
	97,  // 92: anytty.api.v1.ResultEnvelope.remote_cloud_status:type_name -> anytty.api.v1.RemoteCloudStatusResult
	8,   // 93: anytty.api.v1.OperationCancelledEvent.operation:type_name -> anytty.api.v1.OperationStamp
	9,   // 94: anytty.api.v1.ResourceReleasedEvent.resource:type_name -> anytty.api.v1.ResourceHandle
	98,  // 95: anytty.api.v1.EventEnvelope.api_version:type_name -> anytty.api.v1.ApiVersion
	63,  // 96: anytty.api.v1.EventEnvelope.origin_session:type_name -> anytty.api.v1.EndpointSessionStamp
	9,   // 97: anytty.api.v1.EventEnvelope.subscription:type_name -> anytty.api.v1.ResourceHandle
	5,   // 98: anytty.api.v1.EventEnvelope.operation_cancelled:type_name -> anytty.api.v1.OperationCancelledEvent
	6,   // 99: anytty.api.v1.EventEnvelope.resource_released:type_name -> anytty.api.v1.ResourceReleasedEvent
	99,  // 100: anytty.api.v1.EventEnvelope.terminal_lifecycle:type_name -> anytty.api.v1.TerminalLifecycleEvent
	100, // 101: anytty.api.v1.EventEnvelope.storage_changed:type_name -> anytty.api.v1.StorageChangedEvent
	101, // 102: anytty.api.v1.EventEnvelope.file_transfer_completed:type_name -> anytty.api.v1.FileTransferCompletedEvent
