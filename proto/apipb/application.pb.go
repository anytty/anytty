...
func (x *BrowserProxyOpenCommand) Reset() {
	*x = BrowserProxyOpenCommand{}
	mi := &file_apipb_application_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BrowserProxyOpenCommand) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrowserProxyOpenCommand) ProtoMessage() {}

func (x *BrowserProxyOpenCommand) ProtoReflect() protoreflect.Message {
	mi := &file_apipb_application_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrowserProxyOpenCommand.ProtoReflect.Descriptor instead.
func (*BrowserProxyOpenCommand) Descriptor() ([]byte, []int) {
	return file_apipb_application_proto_rawDescGZIP(), []int{2}
}

func (x *BrowserProxyOpenCommand) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
type CommandEnvelope struct {
	...
	//	*CommandEnvelope_RemoteCloudStatus
	//	*CommandEnvelope_RemoteCloudEnable
	//	*CommandEnvelope_RemoteCloudDisable
	//	*CommandEnvelope_BrowserProxyOpen
	//	*CommandEnvelope_Plugin
...
func (x *CommandEnvelope) GetRemoteCloudStatus() *RemoteCloudStatusCommand {
	if x != nil {
		if x, ok := x.Command.(*CommandEnvelope_RemoteCloudStatus); ok {
...
func (x *CommandEnvelope) GetRemoteCloudEnable() *RemoteCloudEnableCommand {
	if x != nil {
		if x, ok := x.Command.(*CommandEnvelope_RemoteCloudEnable); ok {
			return x.RemoteCloudEnable
		}
	}
	return nil
}

func (x *CommandEnvelope) GetRemoteCloudDisable() *RemoteCloudDisableCommand {
	if x != nil {
		if x, ok := x.Command.(*CommandEnvelope_RemoteCloudDisable); ok {
			return x.RemoteCloudDisable
		}
	}
	return nil
}

func (x *CommandEnvelope) GetBrowserProxyOpen() *BrowserProxyOpenCommand {
	if x != nil {
		if x, ok := x.Command.(*CommandEnvelope_BrowserProxyOpen); ok {
			return x.BrowserProxyOpen
		}
	}
	return nil
}

func (x *CommandEnvelope) GetPlugin() *PluginCommand {
	if x != nil {
		if x, ok := x.Command.(*CommandEnvelope_Plugin); ok {
			return x.Plugin
		}
	}
	return nil
...
type CommandEnvelope_RemoteCloudStatus struct {
	RemoteCloudStatus *RemoteCloudStatusCommand `protobuf:"bytes,118,opt,name=remote_cloud_status,json=remoteCloudStatus,proto3,oneof"`
}

type CommandEnvelope_RemoteCloudEnable struct {
	RemoteCloudEnable *RemoteCloudEnableCommand `protobuf:"bytes,119,opt,name=remote_cloud_enable,json=remoteCloudEnable,proto3,oneof"`
}

type CommandEnvelope_RemoteCloudDisable struct {
	RemoteCloudDisable *RemoteCloudDisableCommand `protobuf:"bytes,120,opt,name=remote_cloud_disable,json=remoteCloudDisable,proto3,oneof"`
}

type CommandEnvelope_BrowserProxyOpen struct {
	BrowserProxyOpen *BrowserProxyOpenCommand `protobuf:"bytes,121,opt,name=browser_proxy_open,json=browserProxyOpen,proto3,oneof"`
}

type CommandEnvelope_Plugin struct {
	Plugin *PluginCommand `protobuf:"bytes,130,opt,name=plugin,proto3,oneof"`
}
...
func (*CommandEnvelope_RemoteCloudStatus) isCommandEnvelope_Command() {}

func (*CommandEnvelope_RemoteCloudEnable) isCommandEnvelope_Command() {}

func (*CommandEnvelope_RemoteCloudDisable) isCommandEnvelope_Command() {}

func (*CommandEnvelope_BrowserProxyOpen) isCommandEnvelope_Command() {}

func (*CommandEnvelope_Plugin) isCommandEnvelope_Command() {}
...
type ResultEnvelope struct {
	...
	//	*ResultEnvelope_RemoteCloudStatus
	//	*ResultEnvelope_BrowserProxyOpen
	//	*ResultEnvelope_Plugin
...
func (x *ResultEnvelope) GetRemoteCloudStatus() *RemoteCloudStatusResult {
	if x != nil {
		if x, ok := x.Result.(*ResultEnvelope_RemoteCloudStatus); ok {
			return x.RemoteCloudStatus
		}
	}
	return nil
...
func (x *ResultEnvelope) GetBrowserProxyOpen() *BrowserProxyOpenResult {
	if x != nil {
		if x, ok := x.Result.(*ResultEnvelope_BrowserProxyOpen); ok {
			return x.BrowserProxyOpen
		}
	}
	return nil
...
func (x *ResultEnvelope) GetPlugin() *PluginResult {
	if x != nil {
		if x, ok := x.Result.(*ResultEnvelope_Plugin); ok {
			return x.Plugin
		}
	}
	return nil
...
type ResultEnvelope_RemoteCloudStatus struct {
	RemoteCloudStatus *RemoteCloudStatusResult `protobuf:"bytes,114,opt,name=remote_cloud_status,json=remoteCloudStatus,proto3,oneof"`
}

type ResultEnvelope_BrowserProxyOpen struct {
	BrowserProxyOpen *BrowserProxyOpenResult `protobuf:"bytes,115,opt,name=browser_proxy_open,json=browserProxyOpen,proto3,oneof"`
}

type ResultEnvelope_Plugin struct {
	Plugin *PluginResult `protobuf:"bytes,130,opt,name=plugin,proto3,oneof"`
}
...
func (*ResultEnvelope_RemoteCloudStatus) isResultEnvelope_Result() {}

func (*ResultEnvelope_BrowserProxyOpen) isResultEnvelope_Result() {}

func (*ResultEnvelope_Plugin) isResultEnvelope_Result() {}
...
func (x *BrowserProxyOpenResult) Reset() {
	*x = BrowserProxyOpenResult{}
	mi := &file_apipb_application_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BrowserProxyOpenResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrowserProxyOpenResult) ProtoMessage() {}

func (x *BrowserProxyOpenResult) ProtoReflect() protoreflect.Message {
	mi := &file_apipb_application_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrowserProxyOpenResult.ProtoReflect.Descriptor instead.
func (*BrowserProxyOpenResult) Descriptor() ([]byte, []int) {
	return file_apipb_application_proto_rawDescGZIP(), []int{6}
}

func (x *BrowserProxyOpenResult) GetResource() *ResourceHandle {
	if x != nil {
		return x.Resource
	}
	return nil
...
const file_apipb_application_proto_rawDesc = "" +
	"\n" +
	"\x17apipb/application.proto\x12\ranytty.api.v1\x1a\x12apipb/common.proto\x1a\x12apipb/plugin.proto\x1a\x19apipb/access_remote.proto\x1a\x12apipb/events.proto\x1a\x10apipb/file.proto\x1a\x13apipb/history.proto\x1a\x13apipb/storage.proto\x1a\x14apipb/terminal.proto\"[\n" +
	...
	"\x11send_window_bytes\x18\x04 \x01(\rR\x0fsendWindowBytes\"\xe4$\n" +
	...
	"\x1aremote_cloud_reselect_edge\x18u \x01(\v2-.anytty.api.v1.RemoteCloudReselectEdgeCommandH\x00R\x17remoteCloudReselectEdge\x12Y\n" +
	"\x13remote_cloud_status\x18v \x01(\v2'.anytty.api.v1.RemoteCloudStatusCommandH\x00R\x11remoteCloudStatus\x12Y\n" +
	"\x13remote_cloud_enable\x18w \x01(\v2'.anytty.api.v1.RemoteCloudEnableCommandH\x00R\x11remoteCloudEnable\x12\\\n" +
	"\x14remote_cloud_disable\x18x \x01(\v2(.anytty.api.v1.RemoteCloudDisableCommandH\x00R\x12remoteCloudDisable\x12V\n" +
	"\x12browser_proxy_open\x18y \x01(\v2&.anytty.api.v1.BrowserProxyOpenCommandH\x00R\x10browserProxyOpen\x127\n" +
	"\x06plugin\x18\x82\x01 \x01(\v2\x1c.anytty.api.v1.PluginCommandH\x00R\x06pluginB\t\n" +
	"\acommand\"\x13\n" +
	"\x11AcknowledgeResult\"\xf6\x17\n" +
	...
	"\x12browser_proxy_open\x18s \x01(\v2%.anytty.api.v1.BrowserProxyOpenResultH\x00R\x10browserProxyOpen\x126\n" +
	"\x06plugin\x18\x82\x01 \x01(\v2\x1b.anytty.api.v1.PluginResultH\x00R\x06pluginB\b\n" +
	"\x06result\"\xb1\x01\n" +
...
var file_apipb_application_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_apipb_application_proto_goTypes = []any{
	...
	(*BrowserProxyOpenCommand)(nil),         // 2: anytty.api.v1.BrowserProxyOpenCommand
	(*CommandEnvelope)(nil),                 // 3: anytty.api.v1.CommandEnvelope
	(*AcknowledgeResult)(nil),               // 4: anytty.api.v1.AcknowledgeResult
	(*ResultEnvelope)(nil),                  // 5: anytty.api.v1.ResultEnvelope
	(*BrowserProxyOpenResult)(nil),          // 6: anytty.api.v1.BrowserProxyOpenResult
	(*OperationCancelledEvent)(nil),         // 7: anytty.api.v1.OperationCancelledEvent
	(*ResourceReleasedEvent)(nil),           // 8: anytty.api.v1.ResourceReleasedEvent
	(*EventEnvelope)(nil),                   // 9: anytty.api.v1.EventEnvelope
	(*OperationStamp)(nil),                  // 10: anytty.api.v1.OperationStamp
	(*ResourceHandle)(nil),                  // 11: anytty.api.v1.ResourceHandle
	(*RequestContext)(nil),                  // 12: anytty.api.v1.RequestContext
	(*TerminalDefaultsCommand)(nil),         // 13: anytty.api.v1.TerminalDefaultsCommand
	(*TerminalCreateCommand)(nil),           // 14: anytty.api.v1.TerminalCreateCommand
	(*TerminalListCommand)(nil),             // 15: anytty.api.v1.TerminalListCommand
	(*TerminalGetCommand)(nil),              // 16: anytty.api.v1.TerminalGetCommand
	(*TerminalRestartCommand)(nil),          // 17: anytty.api.v1.TerminalRestartCommand
	(*TerminalKillCommand)(nil),             // 18: anytty.api.v1.TerminalKillCommand
	(*TerminalRemoveCommand)(nil),           // 19: anytty.api.v1.TerminalRemoveCommand
	(*TerminalSetMetadataCommand)(nil),      // 20: anytty.api.v1.TerminalSetMetadataCommand
	(*TerminalSetTagsCommand)(nil),          // 21: anytty.api.v1.TerminalSetTagsCommand
	(*TerminalAttachCommand)(nil),           // 22: anytty.api.v1.TerminalAttachCommand
	(*TerminalDetachCommand)(nil),           // 23: anytty.api.v1.TerminalDetachCommand
	(*TerminalInputCommand)(nil),            // 24: anytty.api.v1.TerminalInputCommand
	(*TerminalResizeCommand)(nil),           // 25: anytty.api.v1.TerminalResizeCommand
	(*TerminalResizeLockCommand)(nil),       // 26: anytty.api.v1.TerminalResizeLockCommand
	(*PathListDirectoriesCommand)(nil),      // 27: anytty.api.v1.PathListDirectoriesCommand
	(*HistoryWindowCommand)(nil),            // 28: anytty.api.v1.HistoryWindowCommand
	(*HistoryCopyCommand)(nil),              // 29: anytty.api.v1.HistoryCopyCommand
	(*HistoryReleaseCommand)(nil),           // 30: anytty.api.v1.HistoryReleaseCommand
	(*HistoryBacklogStatusCommand)(nil),     // 31: anytty.api.v1.HistoryBacklogStatusCommand
	(*LiveScreenNextCommand)(nil),           // 32: anytty.api.v1.LiveScreenNextCommand
	(*HistorySearchCommand)(nil),            // 33: anytty.api.v1.HistorySearchCommand
	(*EventSubscribeCommand)(nil),           // 34: anytty.api.v1.EventSubscribeCommand
	(*FileListCommand)(nil),                 // 35: anytty.api.v1.FileListCommand
	(*FileStatCommand)(nil),                 // 36: anytty.api.v1.FileStatCommand
	(*FilePreviewCommand)(nil),              // 37: anytty.api.v1.FilePreviewCommand
	(*FileMkdirCommand)(nil),                // 38: anytty.api.v1.FileMkdirCommand
	(*FileRenameCommand)(nil),               // 39: anytty.api.v1.FileRenameCommand
	(*FileDeleteCommand)(nil),               // 40: anytty.api.v1.FileDeleteCommand
	(*FileCopyCommand)(nil),                 // 41: anytty.api.v1.FileCopyCommand
	(*FileMoveCommand)(nil),                 // 42: anytty.api.v1.FileMoveCommand
	(*FileDownloadOpenCommand)(nil),         // 43: anytty.api.v1.FileDownloadOpenCommand
	(*FileUploadOpenCommand)(nil),           // 44: anytty.api.v1.FileUploadOpenCommand
	(*FileTransferCancelCommand)(nil),       // 45: anytty.api.v1.FileTransferCancelCommand
	(*StorageGetCommand)(nil),               // 46: anytty.api.v1.StorageGetCommand
	(*StoragePutCommand)(nil),               // 47: anytty.api.v1.StoragePutCommand
	(*StorageDeleteCommand)(nil),            // 48: anytty.api.v1.StorageDeleteCommand
	(*StorageListCommand)(nil),              // 49: anytty.api.v1.StorageListCommand
	(*ClientAccessIdentityCommand)(nil),     // 50: anytty.api.v1.ClientAccessIdentityCommand
	(*ClientAccessListCommand)(nil),         // 51: anytty.api.v1.ClientAccessListCommand
	(*ClientAccessTicketCreateCommand)(nil), // 52: anytty.api.v1.ClientAccessTicketCreateCommand
	(*ClientAccessRevokeCommand)(nil),       // 53: anytty.api.v1.ClientAccessRevokeCommand
	(*RemoteStatusCommand)(nil),             // 54: anytty.api.v1.RemoteStatusCommand
	(*RemotePairStartCommand)(nil),          // 55: anytty.api.v1.RemotePairStartCommand
	(*RemoteLocalEnableCommand)(nil),        // 56: anytty.api.v1.RemoteLocalEnableCommand
	(*RemoteLocalStatusCommand)(nil),        // 57: anytty.api.v1.RemoteLocalStatusCommand
	(*RemoteLocalDisableCommand)(nil),       // 58: anytty.api.v1.RemoteLocalDisableCommand
	(*RemoteCloudEdgesCommand)(nil),         // 59: anytty.api.v1.RemoteCloudEdgesCommand
	(*RemoteCloudPreferEdgeCommand)(nil),    // 60: anytty.api.v1.RemoteCloudPreferEdgeCommand
	(*RemoteCloudReselectEdgeCommand)(nil),  // 61: anytty.api.v1.RemoteCloudReselectEdgeCommand
	(*RemoteCloudStatusCommand)(nil),        // 62: anytty.api.v1.RemoteCloudStatusCommand
	(*RemoteCloudEnableCommand)(nil),        // 63: anytty.api.v1.RemoteCloudEnableCommand
	(*RemoteCloudDisableCommand)(nil),       // 64: anytty.api.v1.RemoteCloudDisableCommand
	(*PluginCommand)(nil),                   // 65: anytty.api.v1.PluginCommand
	(*EndpointSessionStamp)(nil),            // 66: anytty.api.v1.EndpointSessionStamp
	(*ApiError)(nil),                        // 67: anytty.api.v1.ApiError
	(*TerminalDefaultsResult)(nil),          // 68: anytty.api.v1.TerminalDefaultsResult
	(*TerminalCreateResult)(nil),            // 69: anytty.api.v1.TerminalCreateResult
	(*TerminalListResult)(nil),              // 70: anytty.api.v1.TerminalListResult
	(*TerminalGetResult)(nil),               // 71: anytty.api.v1.TerminalGetResult
	(*TerminalAttachResult)(nil),            // 72: anytty.api.v1.TerminalAttachResult
	(*TerminalResizeResult)(nil),            // 73: anytty.api.v1.TerminalResizeResult
	(*PathListDirectoriesResult)(nil),       // 74: anytty.api.v1.PathListDirectoriesResult
	(*HistoryWindowResult)(nil),             // 75: anytty.api.v1.HistoryWindowResult
	(*HistoryCopyResult)(nil),               // 76: anytty.api.v1.HistoryCopyResult
	(*HistoryBacklogStatusResult)(nil),      // 77: anytty.api.v1.HistoryBacklogStatusResult
	(*NativeScreenResult)(nil),              // 78: anytty.api.v1.NativeScreenResult
	(*HistorySearchResult)(nil),             // 79: anytty.api.v1.HistorySearchResult
	(*EventSubscriptionResult)(nil),         // 80: anytty.api.v1.EventSubscriptionResult
	(*FileListResult)(nil),                  // 81: anytty.api.v1.FileListResult
	(*FileStatResult)(nil),                  // 82: anytty.api.v1.FileStatResult
	(*FilePreviewResult)(nil),               // 83: anytty.api.v1.FilePreviewResult
	(*FileOperationResult)(nil),             // 84: anytty.api.v1.FileOperationResult
	(*FileBatchResult)(nil),                 // 85: anytty.api.v1.FileBatchResult
	(*FileTransferOpenResult)(nil),          // 86: anytty.api.v1.FileTransferOpenResult
	(*FileTransferCancelResult)(nil),        // 87: anytty.api.v1.FileTransferCancelResult
	(*StorageGetResult)(nil),                // 88: anytty.api.v1.StorageGetResult
	(*StoragePutResult)(nil),                // 89: anytty.api.v1.StoragePutResult
	(*StorageDeleteResult)(nil),             // 90: anytty.api.v1.StorageDeleteResult
	(*StorageListResult)(nil),               // 91: anytty.api.v1.StorageListResult
	(*ClientAccessIdentityResult)(nil),      // 92: anytty.api.v1.ClientAccessIdentityResult
	(*ClientAccessListResult)(nil),          // 93: anytty.api.v1.ClientAccessListResult
	(*ClientAccessTicketCreateResult)(nil),  // 94: anytty.api.v1.ClientAccessTicketCreateResult
	(*ClientAccessRevokeResult)(nil),        // 95: anytty.api.v1.ClientAccessRevokeResult
	(*RemoteStatusResult)(nil),              // 96: anytty.api.v1.RemoteStatusResult
	(*RemotePairStartResult)(nil),           // 97: anytty.api.v1.RemotePairStartResult
	(*RemoteLocalStatusResult)(nil),         // 98: anytty.api.v1.RemoteLocalStatusResult
	(*RemoteCloudEdgesResult)(nil),          // 99: anytty.api.v1.RemoteCloudEdgesResult
	(*RemoteCloudStatusResult)(nil),         // 100: anytty.api.v1.RemoteCloudStatusResult
	(*PluginResult)(nil),                    // 101: anytty.api.v1.PluginResult
	(*ApiVersion)(nil),                      // 102: anytty.api.v1.ApiVersion
	(*TerminalLifecycleEvent)(nil),          // 103: anytty.api.v1.TerminalLifecycleEvent
	(*StorageChangedEvent)(nil),             // 104: anytty.api.v1.StorageChangedEvent
	(*FileTransferCompletedEvent)(nil),      // 105: anytty.api.v1.FileTransferCompletedEvent
}
var file_apipb_application_proto_depIdxs = []int32{
	10,  // 0: anytty.api.v1.CancelOperationCommand.operation:type_name -> anytty.api.v1.OperationStamp
	11,  // 1: anytty.api.v1.ReleaseResourceCommand.resource:type_name -> anytty.api.v1.ResourceHandle
	12,  // 2: anytty.api.v1.CommandEnvelope.context:type_name -> anytty.api.v1.RequestContext
	...
	13,  // 5: anytty.api.v1.CommandEnvelope.terminal_defaults:type_name -> anytty.api.v1.TerminalDefaultsCommand
	14,  // 6: anytty.api.v1.CommandEnvelope.terminal_create:type_name -> anytty.api.v1.TerminalCreateCommand
	15,  // 7: anytty.api.v1.CommandEnvelope.terminal_list:type_name -> anytty.api.v1.TerminalListCommand
	16,  // 8: anytty.api.v1.CommandEnvelope.terminal_get:type_name -> anytty.api.v1.TerminalGetCommand
	17,  // 9: anytty.api.v1.CommandEnvelope.terminal_restart:type_name -> anytty.api.v1.TerminalRestartCommand
	18,  // 10: anytty.api.v1.CommandEnvelope.terminal_kill:type_name -> anytty.api.v1.TerminalKillCommand
	19,  // 11: anytty.api.v1.CommandEnvelope.terminal_remove:type_name -> anytty.api.v1.TerminalRemoveCommand
	20,  // 12: anytty.api.v1.CommandEnvelope.terminal_set_metadata:type_name -> anytty.api.v1.TerminalSetMetadataCommand
	21,  // 13: anytty.api.v1.CommandEnvelope.terminal_set_tags:type_name -> anytty.api.v1.TerminalSetTagsCommand
	22,  // 14: anytty.api.v1.CommandEnvelope.terminal_attach:type_name -> anytty.api.v1.TerminalAttachCommand
	23,  // 15: anytty.api.v1.CommandEnvelope.terminal_detach:type_name -> anytty.api.v1.TerminalDetachCommand
	24,  // 16: anytty.api.v1.CommandEnvelope.terminal_input:type_name -> anytty.api.v1.TerminalInputCommand
	25,  // 17: anytty.api.v1.CommandEnvelope.terminal_resize:type_name -> anytty.api.v1.TerminalResizeCommand
	26,  // 18: anytty.api.v1.CommandEnvelope.terminal_resize_lock:type_name -> anytty.api.v1.TerminalResizeLockCommand
	27,  // 19: anytty.api.v1.CommandEnvelope.path_list_directories:type_name -> anytty.api.v1.PathListDirectoriesCommand
	28,  // 20: anytty.api.v1.CommandEnvelope.history_window:type_name -> anytty.api.v1.HistoryWindowCommand
	29,  // 21: anytty.api.v1.CommandEnvelope.history_copy:type_name -> anytty.api.v1.HistoryCopyCommand
	30,  // 22: anytty.api.v1.CommandEnvelope.history_release:type_name -> anytty.api.v1.HistoryReleaseCommand
	31,  // 23: anytty.api.v1.CommandEnvelope.history_backlog_status:type_name -> anytty.api.v1.HistoryBacklogStatusCommand
	32,  // 24: anytty.api.v1.CommandEnvelope.live_screen_next:type_name -> anytty.api.v1.LiveScreenNextCommand
	33,  // 25: anytty.api.v1.CommandEnvelope.history_search:type_name -> anytty.api.v1.HistorySearchCommand
	34,  // 26: anytty.api.v1.CommandEnvelope.event_subscribe:type_name -> anytty.api.v1.EventSubscribeCommand
	35,  // 27: anytty.api.v1.CommandEnvelope.file_list:type_name -> anytty.api.v1.FileListCommand
	36,  // 28: anytty.api.v1.CommandEnvelope.file_stat:type_name -> anytty.api.v1.FileStatCommand
	37,  // 29: anytty.api.v1.CommandEnvelope.file_preview:type_name -> anytty.api.v1.FilePreviewCommand
	38,  // 30: anytty.api.v1.CommandEnvelope.file_mkdir:type_name -> anytty.api.v1.FileMkdirCommand
	39,  // 31: anytty.api.v1.CommandEnvelope.file_rename:type_name -> anytty.api.v1.FileRenameCommand
	40,  // 32: anytty.api.v1.CommandEnvelope.file_delete:type_name -> anytty.api.v1.FileDeleteCommand
	41,  // 33: anytty.api.v1.CommandEnvelope.file_copy:type_name -> anytty.api.v1.FileCopyCommand
	42,  // 34: anytty.api.v1.CommandEnvelope.file_move:type_name -> anytty.api.v1.FileMoveCommand
	43,  // 35: anytty.api.v1.CommandEnvelope.file_download_open:type_name -> anytty.api.v1.FileDownloadOpenCommand
	44,  // 36: anytty.api.v1.CommandEnvelope.file_upload_open:type_name -> anytty.api.v1.FileUploadOpenCommand
	45,  // 37: anytty.api.v1.CommandEnvelope.file_transfer_cancel:type_name -> anytty.api.v1.FileTransferCancelCommand
	46,  // 38: anytty.api.v1.CommandEnvelope.storage_get:type_name -> anytty.api.v1.StorageGetCommand
	47,  // 39: anytty.api.v1.CommandEnvelope.storage_put:type_name -> anytty.api.v1.StoragePutCommand
	48,  // 40: anytty.api.v1.CommandEnvelope.storage_delete:type_name -> anytty.api.v1.StorageDeleteCommand
	49,  // 41: anytty.api.v1.CommandEnvelope.storage_list:type_name -> anytty.api.v1.StorageListCommand
	50,  // 42: anytty.api.v1.CommandEnvelope.client_access_identity:type_name -> anytty.api.v1.ClientAccessIdentityCommand
	51,  // 43: anytty.api.v1.CommandEnvelope.client_access_list:type_name -> anytty.api.v1.ClientAccessListCommand
	52,  // 44: anytty.api.v1.CommandEnvelope.client_access_ticket_create:type_name -> anytty.api.v1.ClientAccessTicketCreateCommand
	53,  // 45: anytty.api.v1.CommandEnvelope.client_access_revoke:type_name -> anytty.api.v1.ClientAccessRevokeCommand
	54,  // 46: anytty.api.v1.CommandEnvelope.remote_status:type_name -> anytty.api.v1.RemoteStatusCommand
	55,  // 47: anytty.api.v1.CommandEnvelope.remote_pair_start:type_name -> anytty.api.v1.RemotePairStartCommand
	56,  // 48: anytty.api.v1.CommandEnvelope.remote_local_enable:type_name -> anytty.api.v1.RemoteLocalEnableCommand
	57,  // 49: anytty.api.v1.CommandEnvelope.remote_local_status:type_name -> anytty.api.v1.RemoteLocalStatusCommand
	58,  // 50: anytty.api.v1.CommandEnvelope.remote_local_disable:type_name -> anytty.api.v1.RemoteLocalDisableCommand
	59,  // 51: anytty.api.v1.CommandEnvelope.remote_cloud_edges:type_name -> anytty.api.v1.RemoteCloudEdgesCommand
	60,  // 52: anytty.api.v1.CommandEnvelope.remote_cloud_prefer_edge:type_name -> anytty.api.v1.RemoteCloudPreferEdgeCommand
	61,  // 53: anytty.api.v1.CommandEnvelope.remote_cloud_reselect_edge:type_name -> anytty.api.v1.RemoteCloudReselectEdgeCommand
	62,  // 54: anytty.api.v1.CommandEnvelope.remote_cloud_status:type_name -> anytty.api.v1.RemoteCloudStatusCommand
	63,  // 55: anytty.api.v1.CommandEnvelope.remote_cloud_enable:type_name -> anytty.api.v1.RemoteCloudEnableCommand
	64,  // 56: anytty.api.v1.CommandEnvelope.remote_cloud_disable:type_name -> anytty.api.v1.RemoteCloudDisableCommand
	2,   // 57: anytty.api.v1.CommandEnvelope.browser_proxy_open:type_name -> anytty.api.v1.BrowserProxyOpenCommand
	65,  // 58: anytty.api.v1.CommandEnvelope.plugin:type_name -> anytty.api.v1.PluginCommand
	66,  // 59: anytty.api.v1.ResultEnvelope.origin_session:type_name -> anytty.api.v1.EndpointSessionStamp
	4,   // 60: anytty.api.v1.ResultEnvelope.acknowledge:type_name -> anytty.api.v1.AcknowledgeResult
	67,  // 61: anytty.api.v1.ResultEnvelope.error:type_name -> anytty.api.v1.ApiError
	68,  // 62: anytty.api.v1.ResultEnvelope.terminal_defaults:type_name -> anytty.api.v1.TerminalDefaultsResult
	69,  // 63: anytty.api.v1.ResultEnvelope.terminal_create:type_name -> anytty.api.v1.TerminalCreateResult
	70,  // 64: anytty.api.v1.ResultEnvelope.terminal_list:type_name -> anytty.api.v1.TerminalListResult
	71,  // 65: anytty.api.v1.ResultEnvelope.terminal_get:type_name -> anytty.api.v1.TerminalGetResult
	72,  // 66: anytty.api.v1.ResultEnvelope.terminal_attach:type_name -> anytty.api.v1.TerminalAttachResult
	73,  // 67: anytty.api.v1.ResultEnvelope.terminal_resize:type_name -> anytty.api.v1.TerminalResizeResult
	74,  // 68: anytty.api.v1.ResultEnvelope.path_list_directories:type_name -> anytty.api.v1.PathListDirectoriesResult
	75,  // 69: anytty.api.v1.ResultEnvelope.history_window:type_name -> anytty.api.v1.HistoryWindowResult
	76,  // 70: anytty.api.v1.ResultEnvelope.history_copy:type_name -> anytty.api.v1.HistoryCopyResult
	77,  // 71: anytty.api.v1.ResultEnvelope.history_backlog_status:type_name -> anytty.api.v1.HistoryBacklogStatusResult
	78,  // 72: anytty.api.v1.ResultEnvelope.live_screen:type_name -> anytty.api.v1.NativeScreenResult
	79,  // 73: anytty.api.v1.ResultEnvelope.history_search:type_name -> anytty.api.v1.HistorySearchResult
	80,  // 74: anytty.api.v1.ResultEnvelope.event_subscription:type_name -> anytty.api.v1.EventSubscriptionResult
	81,  // 75: anytty.api.v1.ResultEnvelope.file_list:type_name -> anytty.api.v1.FileListResult
	82,  // 76: anytty.api.v1.ResultEnvelope.file_stat:type_name -> anytty.api.v1.FileStatResult
	83,  // 77: anytty.api.v1.ResultEnvelope.file_preview:type_name -> anytty.api.v1.FilePreviewResult
	84,  // 78: anytty.api.v1.ResultEnvelope.file_operation:type_name -> anytty.api.v1.FileOperationResult
	85,  // 79: anytty.api.v1.ResultEnvelope.file_batch:type_name -> anytty.api.v1.FileBatchResult
	86,  // 80: anytty.api.v1.ResultEnvelope.file_transfer_open:type_name -> anytty.api.v1.FileTransferOpenResult
	87,  // 81: anytty.api.v1.ResultEnvelope.file_transfer_cancel:type_name -> anytty.api.v1.FileTransferCancelResult
	88,  // 82: anytty.api.v1.ResultEnvelope.storage_get:type_name -> anytty.api.v1.StorageGetResult
	89,  // 83: anytty.api.v1.ResultEnvelope.storage_put:type_name -> anytty.api.v1.StoragePutResult
	90,  // 84: anytty.api.v1.ResultEnvelope.storage_delete:type_name -> anytty.api.v1.StorageDeleteResult
	91,  // 85: anytty.api.v1.ResultEnvelope.storage_list:type_name -> anytty.api.v1.StorageListResult
	92,  // 86: anytty.api.v1.ResultEnvelope.client_access_identity:type_name -> anytty.api.v1.ClientAccessIdentityResult
	93,  // 87: anytty.api.v1.ResultEnvelope.client_access_list:type_name -> anytty.api.v1.ClientAccessListResult
	94,  // 88: anytty.api.v1.ResultEnvelope.client_access_ticket_create:type_name -> anytty.api.v1.ClientAccessTicketCreateResult
	95,  // 89: anytty.api.v1.ResultEnvelope.client_access_revoke:type_name -> anytty.api.v1.ClientAccessRevokeResult
	96,  // 90: anytty.api.v1.ResultEnvelope.remote_status:type_name -> anytty.api.v1.RemoteStatusResult
	97,  // 91: anytty.api.v1.ResultEnvelope.remote_pair_start:type_name -> anytty.api.v1.RemotePairStartResult
	98,  // 92: anytty.api.v1.ResultEnvelope.remote_local_status:type_name -> anytty.api.v1.RemoteLocalStatusResult
	99,  // 93: anytty.api.v1.ResultEnvelope.remote_cloud_edges:type_name -> anytty.api.v1.RemoteCloudEdgesResult
	100, // 94: anytty.api.v1.ResultEnvelope.remote_cloud_status:type_name -> anytty.api.v1.RemoteCloudStatusResult
	6,   // 95: anytty.api.v1.ResultEnvelope.browser_proxy_open:type_name -> anytty.api.v1.BrowserProxyOpenResult
	101, // 96: anytty.api.v1.ResultEnvelope.plugin:type_name -> anytty.api.v1.PluginResult
	11,  // 97: anytty.api.v1.BrowserProxyOpenResult.resource:type_name -> anytty.api.v1.ResourceHandle
	10,  // 98: anytty.api.v1.OperationCancelledEvent.operation:type_name -> anytty.api.v1.OperationStamp
	11,  // 99: anytty.api.v1.ResourceReleasedEvent.resource:type_name -> anytty.api.v1.ResourceHandle
	102, // 100: anytty.api.v1.EventEnvelope.api_version:type_name -> anytty.api.v1.ApiVersion
	66,  // 101: anytty.api.v1.EventEnvelope.origin_session:type_name -> anytty.api.v1.EndpointSessionStamp
	11,  // 102: anytty.api.v1.EventEnvelope.subscription:type_name -> anytty.api.v1.ResourceHandle
	7,   // 103: anytty.api.v1.EventEnvelope.operation_cancelled:type_name -> anytty.api.v1.OperationCancelledEvent
	8,   // 104: anytty.api.v1.EventEnvelope.resource_released:type_name -> anytty.api.v1.ResourceReleasedEvent
	103, // 105: anytty.api.v1.EventEnvelope.terminal_lifecycle:type_name -> anytty.api.v1.TerminalLifecycleEvent
	104, // 106: anytty.api.v1.EventEnvelope.storage_changed:type_name -> anytty.api.v1.StorageChangedEvent
	105, // 107: anytty.api.v1.EventEnvelope.file_transfer_completed:type_name -> anytty.api.v1.FileTransferCompletedEvent
...
func file_apipb_application_proto_init() {
	...
	file_apipb_application_proto_msgTypes[3].OneofWrappers = []any{
		...
		(*CommandEnvelope_RemoteCloudStatus)(nil),
		(*CommandEnvelope_RemoteCloudEnable)(nil),
		(*CommandEnvelope_RemoteCloudDisable)(nil),
		(*CommandEnvelope_BrowserProxyOpen)(nil),
		(*CommandEnvelope_Plugin)(nil),
	}
	file_apipb_application_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*ResultEnvelope_RemoteCloudStatus)(nil),
		(*ResultEnvelope_BrowserProxyOpen)(nil),
		(*ResultEnvelope_Plugin)(nil),
	}
	file_apipb_application_proto_msgTypes[9].OneofWrappers = []any{
