...
relay_transport (22.anytty.remote.auth.v1.ManagedWebRTCRelayTransportRrelayTransport"å
...
endpoint_id (	R
endpointIdB
policy (2*.anytty.client.binding.v1.ConnectionPolicyRpolicy"Ý
...
edge_server_name (	RedgeServerName%
locator_source (	RlocatorSource:
refreshed_from_controller (RrefreshedFromController"Â
OpenSessionRequest
...
endpointId%
route_override (	RrouteOverride?
intent (2'.anytty.client.binding.v1.ConnectIntentRintentJ"’
ImportPairingRequest

request_id (	R	requestId)
portable_payload (	RportablePayload0
expected_endpoint_id (	RexpectedEndpointId"Õ
ImportPairingResult
...
expires_at_unix_nano	 (RexpiresAtUnixNano"ß
...
session_handle (RsessionHandle
port (Rport-
error (2.anytty.api.v1.ApiErrorRerror"Ë
...
ApplicationEvent%
session_handle (RsessionHandle2
event (2.anytty.api.v1.EventEnvelopeRevent"Š
OpenResourceStreamRequest9
resource (2.anytty.api.v1.ResourceHandleRresource2
initial_upload_offset (RinitialUploadOffset"›
ResourceStreamFrame#
...
cloud_edge_locator (RcloudEdgeLocator"Ì
CredentialRecord
endpoint_id (	R
endpointId%
credential_ref (	RcredentialRef
...
account_profile_ref (	RaccountProfileRef"Õ
CloudProfileRecord.
...
LocalDiscoveryLookupRequest
	device_id (	RdeviceId-
device_fingerprint (	RdeviceFingerprint"Ê
...
endpoint_id (	R
endpointIdD
mode (20.anytty.client.binding.v1.EndpointSupervisorModeRmode"Â
 EndpointSupervisorDemandSnapshot#
attachment_id (	RattachmentId'
demand_revision (RdemandRevisionP
	endpoints (22.anytty.client.binding.v1.EndpointSupervisorDemandR	endpoints"
...
EndpointSupervisorSnapshotT
	endpoints (26.anytty.client.binding.v1.EndpointSupervisorProjectionR	endpoints*ˆ
...
7CONNECTION_POLICY_AVAILABILITY_REASON_CLOUD_UNAVAILABLE*ƒ
...
!ENDPOINT_CONNECTION_PHASE_OFFLINE*Ž
