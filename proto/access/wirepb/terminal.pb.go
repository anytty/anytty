...
func (x *FileTransferData) GetEncoding() string {
	if x != nil {
		return x.Encoding
	}
	return ""
...
type FileTransferAck struct {
	...
	TransferredBytes int64 `protobuf:"varint,3,opt,name=transferred_bytes,json=transferredBytes,proto3" json:"transferred_bytes,omitempty"`
	TotalBytes       int64 `protobuf:"varint,4,opt,name=total_bytes,json=totalBytes,proto3" json:"total_bytes,omitempty"`
	ElapsedMillis    int64 `protobuf:"varint,5,opt,name=elapsed_millis,json=elapsedMillis,proto3" json:"elapsed_millis,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *FileTransferAck) GetTransferredBytes() int64 {
	if x != nil {
...
func (x *FileTransferAck) GetTotalBytes() int64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
func (x *FileTransferAck) GetElapsedMillis() int64 {
	if x != nil {
...
func (x *FileTransferFinish) GetElapsedMillis() int64 {
	if x != nil {
		return x.ElapsedMillis
	}
	return 0
...
const file_wirepb_terminal_proto_rawDesc = "" +
	...
	"\x05error\x18\x02 \x01(\v2%.anytty.protocol.wirepb.ProtocolErrorR\x05error\"Z\n" +
	"\x10FileTransferData\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x03R\x06offset\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x12\x1a\n" +
	"\bencoding\x18\x03 \x01(\tR\bencoding\"\xc1\x01\n" +
	"\x0fFileTransferAck\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x03R\x06offset\x12!\n" +
	"\fwindow_bytes\x18\x02 \x01(\x03R\vwindowBytes\x12+\n" +
	"\x11transferred_bytes\x18\x03 \x01(\x03R\x10transferredBytes\x12\x1f\n" +
	"\vtotal_bytes\x18\x04 \x01(\x03R\n" +
	"totalBytes\x12%\n" +
	"\x0eelapsed_millis\x18\x05 \x01(\x03R\relapsedMillis\"g\n" +
	"\x12FileTransferFinish\x12\x12\n" +
	"\x04size\x18\x01 \x01(\x03R\x04size\x12\x16\n" +
	"\x06sha256\x18\x02 \x01(\fR\x06sha256\x12%\n" +
	"\x0eelapsed_millis\x18\x03 \x01(\x03R\relapsedMillis\"T\n" +
	"\x12FileTransferResult\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x03R\x04size\x12\x16\n" +
	"\x06sha256\x18\x03 \x01(\fR\x06sha256B.Z,github.com/anytty/anytty/proto/access/wirepbb\x06proto3"
