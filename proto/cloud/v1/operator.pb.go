...
func (x *ListRuntimeSessionsResponse) GetNextCursor() string {
	if x != nil {
		return x.NextCursor
	}
	return ""
...
const file_cloud_v1_operator_proto_rawDesc = "" +
	...
	"\x04page\x18\x01 \x01(\v2\x1c.anytty.cloud.v1.PageRequestR\x04page\"\x85\x01\n" +
	"\x1bListRuntimeSessionsResponse\x12E\n" +
	"\bsessions\x18\x01 \x03(\v2).anytty.cloud.v1.RuntimeSessionProjectionR\bsessions\x12\x1f\n" +
	"\vnext_cursor\x18\x02 \x01(\tR\n" +
	"nextCursor\"M\n" +
	...
	"\x1eOPERATOR_EVENT_OPERATION_RESET\x10\x032\xbe\r\n" +
	...
	"\n" +
	"DeleteEdge\x12\".anytty.cloud.v1.DeleteEdgeRequest\x1a#.anytty.cloud.v1.DeleteEdgeResponse\x12\x85\x01\n" +
