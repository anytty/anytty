...
func (x *ListDaemonsRequest) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListDaemonsRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *ListDaemonsRequest) GetEdgeId() string {
	if x != nil {
		return x.EdgeId
	}
	return ""
...
func (x *ListDaemonsResponse) GetNextCursor() string {
	if x != nil {
		return x.NextCursor
	}
	return ""
...
type DaemonEnrollmentChallenge struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	IdentityChallenge *IdentityChallenge     `protobuf:"bytes,1,opt,name=identity_challenge,json=identityChallenge,proto3" json:"identity_challenge,omitempty"`
	EdgeCandidates    []*DaemonEdgeCandidate `protobuf:"bytes,2,rep,name=edge_candidates,json=edgeCandidates,proto3" json:"edge_candidates,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *DaemonEnrollmentChallenge) Reset() {
	*x = DaemonEnrollmentChallenge{}
	mi := &file_cloud_v1_enrollment_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DaemonEnrollmentChallenge) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DaemonEnrollmentChallenge) ProtoMessage() {}

func (x *DaemonEnrollmentChallenge) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_v1_enrollment_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DaemonEnrollmentChallenge.ProtoReflect.Descriptor instead.
func (*DaemonEnrollmentChallenge) Descriptor() ([]byte, []int) {
	return file_cloud_v1_enrollment_proto_rawDescGZIP(), []int{24}
}

func (x *DaemonEnrollmentChallenge) GetIdentityChallenge() *IdentityChallenge {
	if x != nil {
...
func (x *DaemonEnrollmentChallenge) GetEdgeCandidates() []*DaemonEdgeCandidate {
	if x != nil {
		return x.EdgeCandidates
	}
	return nil
}
...
func (x *CompleteDaemonEnrollmentRequest) GetEdgeMeasurements() []*DaemonEdgeMeasurement {
	if x != nil {
...
func (x *RefreshDaemonBindingResponse) Reset() {
	*x = RefreshDaemonBindingResponse{}
	mi := &file_cloud_v1_enrollment_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RefreshDaemonBindingResponse) Descriptor() ([]byte, []int) {
	return file_cloud_v1_enrollment_proto_rawDescGZIP(), []int{30}
}
...
const file_cloud_v1_enrollment_proto_rawDesc = "" +
	...
	"\fdaemon_limit\x18\x06 \x01(\rR\vdaemonLimit\"x\n" +
	"\x12ListDaemonsRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\rR\bpageSize\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12\x14\n" +
	"\x05query\x18\x03 \x01(\tR\x05query\x12\x17\n" +
	"\aedge_id\x18\x04 \x01(\tR\x06edgeId\"p\n" +
	"\x13ListDaemonsResponse\x128\n" +
	"\adaemons\x18\x01 \x03(\v2\x1e.anytty.cloud.v1.ManagedDaemonR\adaemons\x12\x1f\n" +
	...
	"\n" +
	"expires_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt\"\xbd\x01\n" +
	"\x19DaemonEnrollmentChallenge\x12Q\n" +
	"\x12identity_challenge\x18\x01 \x01(\v2\".anytty.cloud.v1.IdentityChallengeR\x11identityChallenge\x12M\n" +
	"\x0fedge_candidates\x18\x02 \x03(\v2$.anytty.cloud.v1.DaemonEdgeCandidateR\x0eedgeCandidates\"\xbc\x01\n" +
	...
	"\x11edge_measurements\x18\x03 \x03(\v2&.anytty.cloud.v1.DaemonEdgeMeasurementR\x10edgeMeasurements\"\xe6\x01\n" +
	...
	"\x14DAEMON_STATE_DELETED\x10\x032\x82\x04\n" +
	"\x11EnrollmentService\x12r\n" +
	"\x15BeginDaemonEnrollment\x12-.anytty.cloud.v1.BeginDaemonEnrollmentRequest\x1a*.anytty.cloud.v1.DaemonEnrollmentChallenge\x12\x7f\n" +
...
var file_cloud_v1_enrollment_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_cloud_v1_enrollment_proto_goTypes = []any{
	...
	(*DaemonEnrollmentChallenge)(nil),            // 25: anytty.cloud.v1.DaemonEnrollmentChallenge
	(*CompleteDaemonEnrollmentRequest)(nil),      // 26: anytty.cloud.v1.CompleteDaemonEnrollmentRequest
	(*EdgeLocator)(nil),                          // 27: anytty.cloud.v1.EdgeLocator
	(*CompleteDaemonEnrollmentResponse)(nil),     // 28: anytty.cloud.v1.CompleteDaemonEnrollmentResponse
	(*BeginDaemonBindingRefreshRequest)(nil),     // 29: anytty.cloud.v1.BeginDaemonBindingRefreshRequest
	(*CompleteDaemonBindingRefreshRequest)(nil),  // 30: anytty.cloud.v1.CompleteDaemonBindingRefreshRequest
	(*RefreshDaemonBindingResponse)(nil),         // 31: anytty.cloud.v1.RefreshDaemonBindingResponse
	(*timestamppb.Timestamp)(nil),                // 32: google.protobuf.Timestamp
	(*SignedEnvelope)(nil),                       // 33: anytty.cloud.v1.SignedEnvelope
}
var file_cloud_v1_enrollment_proto_depIdxs = []int32{
	...
	32, // 1: anytty.cloud.v1.DaemonRecord.created_at:type_name -> google.protobuf.Timestamp
	32, // 2: anytty.cloud.v1.DaemonRecord.updated_at:type_name -> google.protobuf.Timestamp
	32, // 3: anytty.cloud.v1.DaemonRecord.edge_preference_updated_at:type_name -> google.protobuf.Timestamp
	...
	32, // 7: anytty.cloud.v1.DaemonEdgeMeasurement.measured_at:type_name -> google.protobuf.Timestamp
	27, // 8: anytty.cloud.v1.DaemonEdgeCandidate.locator:type_name -> anytty.cloud.v1.EdgeLocator
	...
	32, // 11: anytty.cloud.v1.DaemonEdgeSelection.evaluated_at:type_name -> google.protobuf.Timestamp
	32, // 12: anytty.cloud.v1.CreateDaemonEnrollmentResponse.expires_at:type_name -> google.protobuf.Timestamp
	...
	32, // 20: anytty.cloud.v1.IdentityChallenge.expires_at:type_name -> google.protobuf.Timestamp
	24, // 21: anytty.cloud.v1.DaemonEnrollmentChallenge.identity_challenge:type_name -> anytty.cloud.v1.IdentityChallenge
	6,  // 22: anytty.cloud.v1.DaemonEnrollmentChallenge.edge_candidates:type_name -> anytty.cloud.v1.DaemonEdgeCandidate
	5,  // 23: anytty.cloud.v1.CompleteDaemonEnrollmentRequest.edge_measurements:type_name -> anytty.cloud.v1.DaemonEdgeMeasurement
