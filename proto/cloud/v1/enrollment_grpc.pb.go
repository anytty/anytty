...
type EnrollmentServiceClient interface {
	BeginDaemonEnrollment(ctx context.Context, in *BeginDaemonEnrollmentRequest, opts ...grpc.CallOption) (*DaemonEnrollmentChallenge, error)
...
func (c *enrollmentServiceClient) BeginDaemonEnrollment(ctx context.Context, in *BeginDaemonEnrollmentRequest, opts ...grpc.CallOption) (*DaemonEnrollmentChallenge, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DaemonEnrollmentChallenge)
...
type EnrollmentServiceServer interface {
	BeginDaemonEnrollment(context.Context, *BeginDaemonEnrollmentRequest) (*DaemonEnrollmentChallenge, error)
...
func (UnimplementedEnrollmentServiceServer) BeginDaemonEnrollment(context.Context, *BeginDaemonEnrollmentRequest) (*DaemonEnrollmentChallenge, error) {
