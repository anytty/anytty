...
func (x *EndpointConfigV1) GetPlatform() string {
	if x != nil {
		return x.Platform
	}
	return ""
...
func (x *EndpointBootstrapBundleV2) GetPlatform() string {
	if x != nil {
		return x.Platform
	}
	return ""
...
func (x *ClientEndpointShareBundleV1) GetPlatform() string {
	if x != nil {
		return x.Platform
	}
	return ""
...
const file_remoteauthpb_remote_auth_proto_rawDesc = "" +
	...
	"\x06routes\x18\x06 \x03(\v2'.anytty.remote.auth.v1.PairingRouteSeedR\x06routes\"\xab\x04\n" +
	...
	"\x06routes\x18\t \x03(\v2,.anytty.remote.auth.v1.EndpointRouteConfigV1R\x06routes\x12\x1a\n" +
	"\bplatform\x18\n" +
	" \x01(\tR\bplatform\"\xb2\x01\n" +
	...
	"\x10bundle_signature\x18\t \x01(\fR\x0fbundleSignature\x12\x1a\n" +
	"\bplatform\x18\n" +
	" \x01(\tR\bplatform\"\x81\x02\n" +
	...
	"\x06bundle\x18\x03 \x01(\v20.anytty.remote.auth.v1.EndpointBootstrapBundleV2R\x06bundle\"\xd2\x05\n" +
	...
	"\x14expires_at_unix_nano\x18\v \x01(\x03R\x11expiresAtUnixNano\x12\x1a\n" +
	"\bplatform\x18\f \x01(\tR\bplatform\"\xb4\x02\n" +
