import { ArrowDownToLine, BookOpen, GitFork, Languages, Menu, PanelLeft } from "lucide-react";
...
interface NavigationItem {
  ...
  current?: boolean;
  emphasis?: boolean;
  kind?: "default" | "github" | "language" | "download";
}
    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          ...
          className={cn("h-11", trigger === "docs" ? "justify-start px-3 font-normal lg:hidden" : "w-11 lg:hidden")}
          aria-label={label}
        >
      ...
      <SheetContent side="right" closeLabel={closeLabel} className="w-[min(88vw,22rem)] border-0 p-0">
                ...
                <SheetClose asChild key={`${item.label}-${item.href}`}>
                  <a
                    ...
                    className={cn(
                      ...
                      "h-11 justify-start px-3 text-sm font-normal",
                    )}
                  >
