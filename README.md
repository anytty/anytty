...
> **Beta:** `v0.0.1-beta.10` provides macOS, Linux, and Windows builds, signed Android APKs for ARMv7, ARM64, x86_64, and universal installs, plus a public iOS TestFlight beta. Protocols and configuration may still change before the first stable release.
...
- Android: [download the Beta APK for your device from GitHub Releases](https://github.com/anytty/anytty/releases/tag/v0.0.1-beta.10).
...
> **Install the app:** The mobile app supports both Android and iOS. Download a signed Android Beta APK from [GitHub Releases](https://github.com/anytty/anytty/releases/tag/v0.0.1-beta.10), or [join the public iOS beta on TestFlight](https://testflight.apple.com/join/rfcgFyJh).
...
curl -fsSL https://raw.githubusercontent.com/anytty/anytty/main/install.sh | \
  sh -s -- --version v0.0.1-beta.10 --bin-dir "$HOME/bin"
```
...
You can also download CLI archives and signed per-ABI or universal Android Beta APKs directly from [GitHub Releases](https://github.com/anytty/anytty/releases/tag/v0.0.1-beta.10). Package definitions for Homebrew, npm, and WinGet are being prepared; see [package manager publishing](docs/PACKAGE_MANAGERS.md) for their current status.
