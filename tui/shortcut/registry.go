...
const (
	...
	SceneTerminalPickerEndpoints SceneID = "terminal_picker_endpoints"
...
var sceneSpecs = []SceneSpec{
	...
	{ID: SceneTerminalPickerEndpoints},
...
func buildPolicies() map[actiondomain.ID]BindingPolicy {
	...
	helpOnly(SceneCopy, "copy.line_start", "copy.line_end", "copy.cursor_left", "copy.cursor_right", "copy.cursor_down", "copy.cursor_up", "copy.accept", "copy.oldest", "copy.newest", "copy.half_page_older", "copy.half_page_newer", "copy.mark", "copy.copy_selection", "copy.search_start", "copy.search_mode", "copy.search_next", "copy.search_previous")
	...
	visible([]SceneID{SceneGlobal, SceneSystem}, true, "plugins.focus_next", "plugins.focus_previous")
	...
	visible([]SceneID{SceneTerminalPicker, SceneTerminalPickerEndpoints}, false, "terminal_picker.endpoints")
	visible([]SceneID{SceneTerminalPicker, SceneTerminalPickerEndpoints, SceneTerminalPickerTags}, false, "terminal_picker.select_previous", "terminal_picker.select_next")
	visible([]SceneID{SceneTerminalPicker, SceneTerminalPickerTags}, false, "terminal_picker.tags")
	visible([]SceneID{SceneTerminalPickerEndpoints}, false, "terminal_picker.endpoint_choose")
