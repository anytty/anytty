...
const (
	...
	ActionTerminalPickerEndpointSelect ID = "terminal_picker.endpoint_select"
	ActionTerminalPickerStatusSelect   ID = "terminal_picker.status_select"
	ActionTerminalPickerTagToggle      ID = "terminal_picker.tag_toggle"
...
var surfaceOnlyActionIDs = []ID{
	...
	ActionTerminalPickerNew, ActionTerminalPickerEndpointSelect, ActionTerminalPickerStatusSelect,
	ActionTerminalPoolSelect, ActionWorkbenchTreeSelect,
